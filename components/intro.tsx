...
export default function Intro() {
  ...
  // Use the useActiveSectionContext hook to get active section data and functions
    ...
    >
      ...
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="https://i.ibb.co/gt8Lnmf/ruslan.png" // https://unsplash.com
              alt="Ruslan portrait"
              width="192"
              height="192"
              quality="95"
      ...
      >
        ...
        <a
          ...
          href="/Ruslan_Tsykaliak_-_Junior_React_Develoåper.pdf"
          download
        >
          Download CV{" "}
